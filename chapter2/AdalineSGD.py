# Implementing ADAptive Linear NEuron with Stochastic gradient descent
# make a few adjustment in fit()
...
class AdalineSGD(object):
    ...
    random_state : int  (default: None)
        Set random state for huffling and
    ...
    def partial_fit(self, X, y):
        """fit training data without reinitializiing the weights"""
